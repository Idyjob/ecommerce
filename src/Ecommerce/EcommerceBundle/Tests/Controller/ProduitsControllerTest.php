...
class ProduitsControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'produits[nom]' => 'Lorem ipsum dolor sit amet',
            'produits[description]' => 'Lorem ipsum dolor sit amet',
            'produits[prix]' => 'Lorem ipsum dolor sit amet',
            'produits[disponible]' => true,
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/produits/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'produits[nom]' => 'Changed',
            'produits[description]' => 'Changed',
            'produits[prix]' => 'Changed',
            'produits[disponible]' => true,
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'produits_filter[nom]' => 'First%',
            'produits_filter[description]' => 'First%',
            'produits_filter[prix]' => 'First%',
            'produits_filter[disponible]' => true,
